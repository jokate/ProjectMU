                                   ...
                                   const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	UAbilityTask_PlayMontageAndWait* PlayAttackTask = UAbilityTask_PlayMontageAndWait::CreatePlayMontageAndWaitProxy(this, TEXT("PlayCombo"),
		ComboData->AnimMontage, 1.0f, GetNextSection(), true );
...
void UMUGA_Attack::StartComboTimer()
{
	...
	//입력까지 기다리는 시간
	const float ComboEffectiveTime = ComboData->EffectiveFrameCount[ComboIndex] / ComboData->FrameRate;
