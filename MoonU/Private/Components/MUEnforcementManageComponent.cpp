...
void UMUEnforcementManageComponent::EnforceAttributeAdded(const int32 CharacterID, FName& EnforcementSlotName,
...
int32 UMUEnforcementManageComponent::GetAllocatedAttribute(const int32 CharacterID, const FName& AttributeSlot)
{
...
int32 UMUEnforcementManageComponent::GetAllocatedSkill(const int32 CharacterID, const ESkillSlotType SkillSlotType)
{
	if ( CharacterEnforcementAllocated.Contains( CharacterID ) == false )
	{
		return -1;
